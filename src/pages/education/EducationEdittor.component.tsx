...
interface EducationEdittorProps {
	onCancel: () => void;
	onSubmit: React.FormEventHandler<HTMLFormElement>;
	register: UseFormRegister<Education>;
	formFields: EducationFormField[];
	errors: FieldErrors<Education>;
}

const EducationEdittor = ({ onCancel, onSubmit, register, formFields, errors }: EducationEdittorProps) => {
	return (
		<CardLayout className="p-6 border-blue-200 bg-blue-50/20 mb-8">
			...
			<form id="education-editor-form" className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={onSubmit}>
...
export default EducationEdittor;
